const CACHE='uchinoko-app-1.1.0';
const ASSETS=["./", "index.html", "style.css?v=1.1.0", "app.js?v=1.1.0", "media.js?v=6", "diary.js?v=6", "feeding.js?v=1.1.0", "preventive.js?v=1.1.0", "grooming.js?v=1.1.0", "modal-layout.js?v=6", "pwa.js", "splash.css?v=1.0.2", "splash.js?v=1.0.2", "dog.jpg", "manifest.webmanifest", "icon-180.png", "icon-192.png", "icon-512.png"];
