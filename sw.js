const CACHE='uchinoko-app-1.1.3';
const ASSETS=["./", "index.html", "style.css?v=1.1.3", "app.js?v=1.1.3", "media.js?v=6", "diary.js?v=6", "feeding.js?v=1.1.2", "preventive.js?v=1.1.0", "history-ui.js?v=1.1.1", "grooming.js?v=1.1.3", "modal-layout.js?v=6", "pwa.js", "splash.css?v=1.0.2", "splash.js?v=1.0.2", "dog.jpg", "manifest.webmanifest", "icon-180.png", "icon-192.png", "icon-512.png"];
